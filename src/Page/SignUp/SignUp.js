...
const SignUp = () => {
    return (
        <section class="bg-white lg:flex lg:flex-row-reverse max-w-[1440px] mx-auto">
            <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
                <form class="w-full max-w-md bg-gray-800 p-5 rounded-lg">
            ...
            <img className='lg:w-1/3' src={signup} alt='login' />
        </section>
    );
};
